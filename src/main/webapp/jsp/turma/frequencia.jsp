...
<script type="text/javascript">
		function validar() {
			var msgErro = 'Você deve Preencher um valor para \n';
			var controle = 0;
			
			decisao = confirm("Confira os dados antes de confirmar, pois uma vez que esta operação seja realizada a mesma não poderá ser desfeita e/ou alterada para a data selecionada.");
           ...
           <!-- Formulário -->
            ...
            <div class="text-center">
	            <s:form id="formCadastro"  method="POST" action="frequenciaTurma" onsubmit="return validar();" cssClass=".form-horizontal text-center" role="form">
	       			<legend>Formulário de Frequência</legend>
