...
<script type="text/javascript">
		function validar() {
			...
			var alunosSelecionados = $("#formCadastro_alunosSelecionados").html();
			if(alunosSelecionados == "\n" || alunosSelecionados == "\n    \t\n" ){
				msgErro	 = msgErro + "Para salvar ao menos um aluno deve ser selecionado. \n";
				controle = 1;
			}
			if(controle == 1){
				alert(msgErro);
      ...
      <div class="container pagina fundo-azul"> <!-- Conteudo -->  
          ...
          <!-- Formulário -->
            ...
            <div class="text-center">
	            <s:form id="formCadastro"  method="POST" action="matricularTurma" onsubmit="return validar();" cssClass=".form-horizontal text-center" role="form">
	       			<legend>Formulário de Matrícula</legend>
						<s:hidden id="idUsuario" name="turma.id" />
						<table align="center">
									<tr>
									    <td><label class="control-label">Alunos:</label></td>
									    <td><s:optiontransferselect cssClass="form-control" buttonCssClass="btn" doubleCssClass="form-control" doubleList="turma.alunos" doubleName="alunosSelecionados" doubleListKey="id" doubleListValue="nome" list="alunos" name="alunos"/></td>
									</tr>
						</table>
						  <div class="row acoes">
			                  <div class="col-md-12 text-center">
			                  	<s:submit  action="matricularTurma" cssClass="btn btn-primary" value="Gravar"/>
