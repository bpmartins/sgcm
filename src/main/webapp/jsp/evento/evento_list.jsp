...
<html lang="en">
  <head>
    ...
    <title>SGCM - Manutenção de Eventos</title>
    ...
    <div class="topo fundo-topo-rodape">
      ...
      <div class="container pagina fundo-azul"> <!-- Conteudo -->  
         ...
         <div class="row fundo-filtro-acoes filtros">
            <div class="col-md-12">     
             <form class="form-inline text-center" role="form" id="formCadastro"  method="POST" action="listarEvento" onsubmit="return validar();">
				...
				<table border="2" class="table table-striped table-bordered table-hover table-condensed">
					...
					<s:iterator value="eventos">
						<tr>
							...
							<td><s:url action="formAlterarEvento" var="alt">
									<s:param name="id" value="id" />
								</s:url> <a href='<s:property value="#alt"/>'><img src="img/alterar.png"></a>
							</td>
							<td><s:url action="deletarEvento" var="del">
									<s:param name="id" value="id" />
 	     ...
 	     <div class="row fundo-filtro-acoes acoes">
            ...
            <form class="form-inline text-center" role="form" id="formCadastro"  method="POST" action="cadastrarEvento" onsubmit="return validar();">
              <button type="submit" class="btn btn-info"  name="action:cadastrarEvento"><span class="glyphicon glyphicon-floppy-disk"></span> Novo</button>
              <button type="submit" class="btn btn-default" name="action:cancelarEvento">Cancelar</button>
			</form>
            </div>
          </div>	         
