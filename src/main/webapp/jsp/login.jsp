...
<div class="container">
	<section id="content">
		<form action="logarUsuario" method="POST"/>
			<h1>Login</h1>
			<div>
				<input type="text" placeholder="Username" required="" id="username" name="usuario.login" id="idLogin" />
			</div>
			<div>
				<input type="password" placeholder="Password" required="" id="password" name="usuario.senha" id="idSenha"/>
			</div>
			<div>
