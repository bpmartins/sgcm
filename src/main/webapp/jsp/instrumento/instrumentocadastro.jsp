...
<html lang="en">
  <head>
    ...
    <title>SGCM - Manutenção de Instrumento</title>
          ...
          <!-- Formulário -->
            ...
            <div class="text-center">
	            <s:form id="formCadastro"  method="POST" action="executeInstrumento" onsubmit="return validar();" cssClass=".form-horizontal text-center" role="form">
	       			<legend>Formulário de Instrumento</legend>
						<s:hidden id="idInstrumento" name="instrumento.id" />
						<table align="center">
						<tr>
						    <td><label class="control-label">Descrição*:</label></td>
							<td><s:textfield cssClass="form-control" name="instrumento.descricao" label="Descrição" required="true" id="idDescricao"/></td>
						</tr>
						<tr>
