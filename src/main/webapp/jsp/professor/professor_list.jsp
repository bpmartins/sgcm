...
<html lang="en">
  <head>
    ...
    <title>SGCM - Manutenção de Professores</title>
    ...
    <div class="topo fundo-topo-rodape">
      ...
      <div class="container pagina fundo-azul"> <!-- Conteudo -->  
         ...
         <div class="row fundo-filtro-acoes filtros">
            <div class="col-md-12">     
             <form class="form-inline text-center" role="form" id="formCadastro"  method="POST" action="listarProfessor" onsubmit="return validar();">
				...
				<table border="2" class="table table-striped table-bordered table-hover table-condensed">
					...
					<s:iterator value="professores">
						<tr>
							...
							<td><s:url action="formAlterarProfessor" var="alt">
									<s:param name="id" value="id" />
								</s:url> <a href='<s:property value="#alt"/>'><img src="img/alterar.png"></a>
							</td>
							<td><s:url action="deletarProfessor" var="del">
									<s:param name="id" value="id" />
 	     ...
 	     <div class="row fundo-filtro-acoes acoes">
            ...
            <form class="form-inline text-center" role="form" id="formCadastro"  method="POST" action="cadastrarProfessor">
              <button type="submit" class="btn btn-info"  name="action:cadastrarProfessor"><span class="glyphicon glyphicon-floppy-disk"></span> Novo</button>
              <button type="submit" class="btn btn-default" name="action:cancelarProfessor">Cancelar</button>
			</form>
            </div>
          </div>	         
