...
<html lang="en">
  <head>
    ...
    <title>SGCM - Manutenção de Perfis</title>
      ...
      <div class="container pagina fundo-azul"> <!-- Conteudo -->  
          ...
          <div class="menu">
            <ul class="nav nav-pills">	
			  ...
			  <li class="active"><s:a action="formListarPerfil.action">Perfis</s:a></li>
			  </s:if>
			  <s:if test="#session.usuario.perfil.id == 1">
         ...
         <div class="row fundo-filtro-acoes filtros">
            <div class="col-md-12">     
             <form class="form-inline text-center" role="form" id="formCadastro"  method="POST" action="listarPerfil" onsubmit="return validar();">
 	     ...
 	     <div class="row fundo-filtro-acoes acoes">
            ...
            <form class="form-inline text-center" role="form" id="formCadastro"  method="POST" action="cadastrarPerfil">
              <button type="submit" class="btn btn-info"  name="action:cadastrarPerfil"><span class="glyphicon glyphicon-floppy-disk"></span> Novo</button>
              <button type="submit" class="btn btn-default" name="action:cancelarPerfil">Cancelar</button>
			</form>
            </div>
          </div>	         
