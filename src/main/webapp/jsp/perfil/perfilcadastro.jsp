...
<html lang="en">
  <head>
    ...
    <title>SGCM - Manutenção de Perfil</title>
    ...
    <div class="topo fundo-topo-rodape">
      ...
      <div class="container pagina fundo-azul"> <!-- Conteudo -->  
          ...
          <!-- Formulário -->
            ...
            <div class="col-md-12">
            	<s:form id="formCadastro"  method="POST" action="executeUsuario" onsubmit="return validar();" cssClass="form-inline text-center" role="form">
            	<legend>Formulário de Perfil</legend>
					<table align="center">
					<tr><s:hidden id="idPerfil" name="perfil.id" /></tr>
					<tr>
						<div class="form-group">
							<label class="form-inline">Descrição :</label>
							<s:textfield cssClass="form-control input-medium "  name="perfil.descricao" required="true" id="idDescricao"/>
						</div>
					</tr>
				    </table>
				  <div class="row acoes">
                  <div class="col-md-12 text-center">
                  	<s:submit action="executePerfil" cssClass="btn btn-primary" value="Gravar"/>
